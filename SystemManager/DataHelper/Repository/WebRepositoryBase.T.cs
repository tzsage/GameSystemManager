...
namespace DataHelper.Repository
{
    public class WebRepositoryBase<TEntity> : IRepositoryBase<TEntity> where TEntity : class, new()
    {
        public SystemDBContext dbcontext = new SystemDBContext();
        ...
        public List<TEntity> FindList(Expression<Func<TEntity, bool>> predicate, Pagination pagination)
        {
            ...
            string[] _order= !string.IsNullOrEmpty(pagination.sidx)?pagination.sidx.Split(','):null;
